...
var time;
var colordisplay;
hgscore = localStorage.getItem("highscr", hgscore);
var askedques = [];
var questions = [{
...
function timing() {
    ...
    timedisplay = setInterval(function() {
        ...
        if (time == -1) {
            ...
            localStorage.setItem("highscr", hgscore);
...
function finalscoree() {
    ...
    document.getElementById("hgscore").innerHTML = localStorage.getItem("highscr", hgscore);
    var initscore = 0;
